ns('Gob.Pcm.UI.Web.Components.Validator.Resources');
Gob.Pcm.UI.Web.Components.Validator.Resources.LabelTitleSummary = 'Debe ingresar';

ns('Gob.Pcm.UI.Web.Components.Validator');
Gob.Pcm.UI.Web.Components.Validator = function (opts) {
    this.init(opts);
};

ns('Gob.Pcm.UI.General.DerechoAcuicola.FormularioRegistro');

Gob.Pcm.UI.Web.Components.Validator.prototype = {
    form: null,
