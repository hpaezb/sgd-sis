...
public class DocumentoObjServiceImp implements DocumentoObjService{
    ...
    public DocumentoObjBean leerActaNotificacion(String pnuAnn, String pnuEmi, String pnuDes, String pnuActa){
        DocumentoObjBean docObjBean = null;
        docObjBean = documentoObjDao.leerActaNotificacion(pnuAnn, pnuEmi, pnuDes,pnuActa);
        return(docObjBean);
    ...
    public List<DocumentoObjBean> leerDocumentoAnexo(String pnuAnn, String pnuEmi){
        ...
        docObjBean = documentoObjDao.leerDocumentoAnexo(pnuAnn, pnuEmi);
        return(docObjBean);
        ...
        if (docVerBean.isInDoc()){
            ...
            */
            ...
            if(docDatoBean.getTiEmi().equals("01")){
               ...
               nombreDoc = "TEMP|R"+docDatoBean.getNuCorEmi()+"."+docObjBean.getTipoDoc();
            }
   ...
   //YUAL
    @Override
   public DocumentoVerBean getNombreDocInicial(String pnuAnn, String pnuEmi){
        DocumentoVerBean docVerBean= new DocumentoVerBean();
   ...
   public DocumentoVerBean getNombreGeneraDocx(String pnuAnn, String pnuEmi,String ptiOpe){
    ...
    public String CopiarAnexo(String pnuAnn, String pnuEmi, String pnuAnexo,String pNuAnnDocProyecto, String pnuEmiDocProyecto){
     String result="";
        result = documentoObjDao.CopiarAnexo(pnuAnn, pnuEmi, pnuAnexo,pNuAnnDocProyecto,pnuEmiDocProyecto);
   ...
   @Override
   public DocumentoVerBean getNombreDocAnexoArchivado(String pnuAnn, String pnuEmi,String pnuDes){
        DocumentoVerBean docVerBean= new DocumentoVerBean();
        
        docVerBean.setNuAnn(pnuAnn);
        docVerBean.setNuEmi(pnuEmi);
        docVerBean.setNuAne(pnuDes); 
        docVerBean.setInDoc(false);
        
        DocumentoObjBean docObjBean = null;
        
        docObjBean = this.getNombreArchivoAnexo(pnuAnn, pnuEmi, pnuDes);
        if (docObjBean!=null && docObjBean.getNuTamano()>0){
            docVerBean.setInDoc(true);
        }
   ...
   public DocumentoVerBean getNombreFirmaDoc(String pnuAnn, String pnuEmi,String ptiOpe,UsuarioConfigBean usuarioConfig, String rutaReporteBase) {
        ...
        if (docDatoBean!=null ){
            if( (docDatoBean.getTiEmi().equals("01") && docDatoBean.getEsDocEmi().equals("7") && ptiOpe.equals("5")) || ( docDatoBean.getTiEmi().equals("05") && docDatoBean.getEsDocEmi().equals("5") && ptiOpe.equals("5")) ){
        ...
        */
        ...
        if (docVerBean.isInDoc()){
            ...
            if (docVerBean.getCoDocEmi().equals("232") || docVerBean.getCoDocEmi().equals("304")){
                ...
                String vgnumDoc = cadena+"$"+docDatoBean.getDeLugar()+"$"+docDatoBean.getFechaFirma().replace("-", "$");
...
//                        vnumDoc =  docDatoBean.getTipoDoc()+"$"+docDatoBean.getNumeroDoc()+"-"+docDatoBean.getNuAnn()+"-"+docDatoBean.getSiglasDoc()+"!"+applicationProperties.getSiglaInstitucion()+"$"+docDatoBean.getDeLugar()+"$"+docDatoBean.getFechaFirma().replace("-", "$");                        
                        vnumDoc =  cadena+"$"+docDatoBean.getDeLugar()+"$"+docDatoBean.getFechaFirma().replace("-", "$");
...
//                        nombreFirma = "TEMP|"+vnum_reg+docDatoBean.getTipoDoc()+"-"+vnumDoc+"-N";
   ...
   public DocumentoVerBean getNombreCargaFirmaDoc(String pnuAnn, String pnuEmi,String ptiOpe){
        ...
        docDatoBean = getDatosDoc(pnuAnn, pnuEmi);
        if (docDatoBean!=null){
            if((docDatoBean.getTiEmi().equals("01") && docDatoBean.getEsDocEmi().equals("7") && ptiOpe.equals("6"))||(docDatoBean.getTiEmi().equals("05")  && docDatoBean.getEsDocEmi().equals("5") && ptiOpe.equals("6"))){
                    docVerBean.setDeMensaje("OK");
                    docVerBean.setInDoc(true);
                    docVerBean.setNuSecFirma(docDatoBean.getNuSecFirma());
                    docVerBean.setFeFirma(docDatoBean.getFechaActual());
...
//                String rutaImagen = rutaReporteBase + "/logo_onpe.jpg";
   ...
   public DocumentoVerBean getNombreCargaVoBoDoc(String pnuAnn, String pnuEmi,String ptiOpe){
        ...
        docDatoBean = getDatosDoc(pnuAnn, pnuEmi);
        if (docDatoBean!=null){
            if((docDatoBean.getTiEmi().equals("01") && (docDatoBean.getEsDocEmi().equals("5")||docDatoBean.getEsDocEmi().equals("7"))||(docDatoBean.getTiEmi().equals("05") && (docDatoBean.getEsDocEmi().equals("5")) ) && ptiOpe.equals("6"))){
                    docVerBean.setDeMensaje("OK");
                    docVerBean.setInDoc(true);
                    docVerBean.setNuSecFirma(docDatoBean.getNuSecFirma());
                    docVerBean.setFeFirma(docDatoBean.getFechaActual());
...
//            }
   ...
   @Override
   public DocumentoVerBean getNombreCargaFirmaDocAnexo(String pnuAnn, String pnuEmi, String pnuAne,String ptiOpe){
        DocumentoVerBean docVerBean= new DocumentoVerBean();
    ...
    public String generarFormatoSiglasFirma(String tipoDoc, String nuDoc, String anio, String institucion, String uuoo){
        ...
        cadenaSiglas=cadenaSiglas.replace("â", "");
        return cadenaSiglas;
    }
...
//                String rutaImagen = rutaReporteBase + "/logo_onpe.jpg";                
    ...
    public ReporteBean getGenerarReporte(String formato,String rutaReporteBase,Map parametros,String archivoServer,String nuAnn, String nuEmi)
    {
        ...
        try{          
            ...
            //YUAL cambiadode de generateRandomNumber2 a generateRandomNumber2
            nombreArchivo = Utilidades.generateRandomNumber2(25);
    ...
    public DocumentoVerBean getNombreFirmaDocReporte(String pnuAnn, String pnuEmi, String ptiOpe, UsuarioConfigBean usuarioConfig, String rutaReporteBase) {
        ...
        if (docDatoBean!=null ){
            if( (docDatoBean.getTiEmi().equals("01") && docDatoBean.getEsDocEmi().equals("7") && ptiOpe.equals("5")) || ( docDatoBean.getTiEmi().equals("05") && docDatoBean.getEsDocEmi().equals("5") && ptiOpe.equals("5")) ){
                ...
                //agregando posicion de firma de documento
                /*if(vin_pref.equals("1")){//firma y numera
                    vin_pref="120";
                }*/
        ...
        if (docVerBean.isInDoc()){
            ...
            if(docDatoBean.getTiEmi().equals("01") || docDatoBean.getTiEmi().equals("05")){
               ...
               if(ptiOpe.equals("5")){
                   ...
                   //YUAL
                   //obtener cargo de persona firmante
                   if(this.esEmisionAdm(docDatoBean.getTiEmi())){
                       docVerBean.setCargoEmpleado(this.getCargoEmpleado(docDatoBean.getCoDepEmi(), docDatoBean.getCoEmpEmi()));
                   }
                   ...
                   // Verificamos el Software de Firma
                    if(usuarioConfig.getSwFirma()!=null && usuarioConfig.getSwFirma().equals("O") ) {
                        ...
                        String cadena = generarFormatoSiglasFirma(docDatoBean.getTipoDoc(), docDatoBean.getNumeroDoc(),docDatoBean.getNuAnn(), applicationProperties.getSiglaInstitucion() , docDatoBean.getSiglasDoc());
//                        vnumDoc =  docDatoBean.getTipoDoc()+"$"+docDatoBean.getNumeroDoc()+"-"+docDatoBean.getNuAnn()+"-"+docDatoBean.getSiglasDoc()+"!"+applicationProperties.getSiglaInstitucion()+"$"+docDatoBean.getDeLugar()+"$"+docDatoBean.getFechaFirma().replace("-", "$");                        
                        vnumDoc =  cadena.replace("", "")+"$"+docDatoBean.getDeLugar()+"$"+docDatoBean.getFechaFirma().replace("-", "$");/*SEGDI MVALDERA QUITA ESPACIO DESABILITADO*/
//                        vnumDoc =  "Prueba"+"$"+docDatoBean.getNumeroDoc()+"-"+docDatoBean.getNuAnn()+"-"+docDatoBean.getSiglasDoc()+"!"+applicationProperties.getSiglaInstitucion()+"$"+docDatoBean.getDeLugar()+"$"+docDatoBean.getFechaFirma().replace("-", "$");
...
//                        nombreFirma = "TEMP|"+vnum_reg+docDatoBean.getTipoDoc()+"-"+vnumDoc+"-N";
                 ...
                 String bCargaDoc="0";
                 bCargaDoc = documentoBasicoDao.verificaCargaDoc(pnuAnn, pnuEmi);
                // Para el Caso de Proveidos se tiene que generar
                // yual
            if ((docVerBean.getCoDocEmi().equals("232") || docVerBean.getCoDocEmi().equals("304"))&&bCargaDoc.equals("0")){
...
//                String rutaImagen = rutaReporteBase + "/logo_onpe.jpg";
    ...
    public DocumentoObjBean leerDocumento(String pnuAnn, String pnuEmi, String ptiCap, String pAbreWord) {
     ...
     private String getCargoEmpleado(String coDep, String coEmp){
        String cargoEmp="";
        if(this.hasParam(coDep, coEmp)){
            cargoEmp = commonQryService.getCargoEmpleado(coDep, coEmp);
        }
        return cargoEmp;
     }
     
     private boolean hasParam(String string1, String string2){
        return string1!=null&&string2!=null&&string1.trim().length()>0&&string2.trim().length()>0;
     }
     
    private boolean esEmisionAdm(String tiEmi){
        return Constantes.TIPO_EMISION_DEPENDENCIAS.equals(tiEmi);
    }
    
     @Override
    public ReporteBean getGenerarReporteNotificacion(BuscarDocumentoEmiConsulBean buscarDocumentoEmiConsulBean,Map parametros)
    {
        ReporteBean objReporte = new ReporteBean();
        String eserror="1";//si
        String coRespuesta="";
        ...
        try{          
            ...
            List lista = null;
            try{
                lista = documentoObjDao.CargarReporteNotificacion(buscarDocumentoEmiConsulBean.getCoAnnio(), buscarDocumentoEmiConsulBean.getCoEmi(),buscarDocumentoEmiConsulBean.getFormatoReporte());
                eserror="0";
            }catch(Exception ex){               
                eserror="1";
                deRespuesta=ex.getMessage();
            ...
            if(buscarDocumentoEmiConsulBean.getFormatoReporte().equalsIgnoreCase("1")){
                coReporte = "TR_100_NOTI"; 
                extensionArch=".pdf";
                tipoArchivo = 2;
            }
            else if(buscarDocumentoEmiConsulBean.getFormatoReporte().equalsIgnoreCase("2")){
                coReporte = "TR_101_NOTI_D";  
                extensionArch=".pdf";
                tipoArchivo = 2;
            }
            else{
               coRespuesta = "1";
               deRespuesta="El tipo de plantilla no existe.";
               throw new Exception(deRespuesta);
            }
            ...
            nombreArchivo = Utilidades.generateRandomNumber2(20);
            prutaReporte = "NOTIFICACION_"+nombreArchivo + extensionArch;
            deNoDoc = "temp|NOTIFICACION_"+nombreArchivo+extensionArch;
            ...
            java.util.logging.Logger.getLogger(ConsultaEmiDocServiceImp.class.getName()).log(Level.SEVERE, null, ex);
            eserror="1";
            deRespuesta=ex.getMessage();
        } catch (FileNotFoundException ex) {
            java.util.logging.Logger.getLogger(ConsultaEmiDocServiceImp.class.getName()).log(Level.SEVERE, null, ex);
