 ...
 * @author ECueva
 */
public class BuscarDocumentoRecepConsulBean extends ReporteBean {
    ...
    */
    public BuscarDocumentoRecepConsulBean() {
    }
    ...
    public String getBusRemitente() {
        return busRemitente;
    }

    public void setBusRemitente(String busRemitente) {
        this.busRemitente = busRemitente;
    }
