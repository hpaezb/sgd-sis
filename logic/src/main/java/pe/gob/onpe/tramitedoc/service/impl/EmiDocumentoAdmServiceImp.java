...
//    private NotificacionService notiService;    
    ...
    public ProcessResult<List<DocumentoBean>> getDocumentosBuscaEmiAdmList(BuscarDocumentoEmiBean buscarDocumentoEmi,FiltroPaginate paginate) {
     return emiDocumentoAdmDao.getDocumentosBuscaEmiAdmList(buscarDocumentoEmi,paginate);
    }
...
//        }
 ...
 @Override
                          ...
                          //YUAL
                             ...
                             for(int i=0; i<lsReferencia.size(); i++)
                             {
                               ...
                               //  if(oReferenciaRemitoBean.getNu_des_ref()!=null){
                                 g=emiDocumentoPersonalDao.updEstadoDocumentoAdmReferenciasRecibido(pcoUseMod, oReferenciaRemitoBean.getNu_emi(), oReferenciaRemitoBean.getNu_ann(),oReferenciaRemitoBean.getNu_des_ref());
                                 //}
                             }
                             //end yual
                            ...
                            if(vReturn.equals("OK")){
                               ...
                               if(!vReturn.equals("OK")){
                                ...
                                //LIMPIAR PROVEIDO
                                if(documentoEmiBean.getCoTipDocAdm().equals("232") || documentoEmiBean.getCoTipDocAdm().equals("304") ){
                                  emiDocumentoAdmDao.updDocumentoLimpiarObj(documentoEmiBean);  
                                }
                               }
                            }else{
    ...
    public String getUsuarioNofirmaProveido(String pcoEmpleado) {
        ...
        try {
            vReturn = emiDocumentoAdmDao.getUsuarioNofirmaProveido(pcoEmpleado);
            ...
            try {
                ...
                if(documentoEmiBean!=null&&documentoEmiBean.getEsDocEmi()!=null&&documentoEmiBean.getEsDocEmi().equals("7")){
                    if(!documentoEmiBean.getCoEmpEmi().equals(usuario.getCempCodemp())){
                        ...
                        docObjBean.setNumeroSecuencia(nuSecFirma);
                        docObjBean.setCoUseMod(documentoEmiBean.getCoUseMod());
                        String NoFirma = emiDocumentoAdmDao.getUsuarioNofirmaProveido(usuario.getCempCodemp());
                        if(NoFirma.equals("1") && documentoEmiBean.getCoTipDocAdm().equals("232") )
                        {
                        //NO VALIDA LA FIRMA DEL PROVEIDO
                        }
                        else{
                    ...
                    for(int i=0; i<lsReferencia.size(); i++)
                    {
                        oReferenciaRemitoBean=lsReferencia.get(i);
                      //  if(oReferenciaRemitoBean.getNu_des_ref()!=null){
                        g=emiDocumentoPersonalDao.updEstadoDocumentoAdmReferenciasEmitido(docObjBean.getCoUseMod(), oReferenciaRemitoBean.getNu_emi(), oReferenciaRemitoBean.getNu_ann(),oReferenciaRemitoBean.getNu_des_ref());
                        //}
                    }
                    //end yual
...
//                System.out.println(""+cCant);
              /*COMENTADO POR QUE GENERA PROBLEMAS CUANDO EMITE DOCUMENTOS A MENSAJERÍA  
                if (cCant==0)
                {*/
    ...
    public HashMap getDocumentosEnReferencia(BuscarDocumentoEmiBean buscarDocumentoEmiBean){
        ...
        try{
            ...
            if(documentoEmiBean!=null && documentoEmiBean.getMsjResult()!=null && documentoEmiBean.getMsjResult().equals("OK")){
                ...
                list = emiDocumentoAdmDao.getDocumentosReferenciadoBusq(documentoEmiBean,buscarDocumentoEmiBean.getsTiAcceso());                
...
/*lista grupos SEGDI MVALDERA*/
    @Override
    public String getLstDestExternoAgregaGrupo(String pcoGrupo, String ptiDes) {
        StringBuilder retval = new StringBuilder();
//        String vRespuesta;
        String coRespuesta;
        List<DestinatarioDocumentoEmiBean> list = null;
        ...
        try {
            list = emiDocumentoAdmDao.getLstDestExternoGrupo(pcoGrupo, ptiDes);
            if (list != null) {
                Writer strWriter = new StringWriter();
                ObjectMapper mapper = new ObjectMapper();
