 ...
 * @author NGilt
 */
public class DocumentoSeguiEstRecibidoBean {
    private String nuAnn;
    private String nuEmi;
    private String nuDes;
    private String nuCorDes;
    private String feEmiCorta;//Fecha de emision
    private String feEmi;
    private String deOriEmi;//REMITENTE
    private String deTipDocAdm;//Tipo de documento
    private String nuDoc;//Numero de documento
    private String deEmpDes;//Destinatario
    private String deAsuM;//Asunto
    private String nuExpediente;//Numero expediente
    ...
    private String fLimite;//fecha limite
    private String fLimiteCorta;//fecha limite
    private String coEstVen;
    private String nuDiaExc;//Dias exceso del plazo
    ...
    public String getDeEsDocRec() {
        return deEsDocRec;
    }

    public void setDeEsDocRec(String deEsDocRec) {
        this.deEsDocRec = deEsDocRec;
    }
    ...
    public String getFeAtencionCorta() {
        return feAtencionCorta;
    }

    public void setFeAtencionCorta(String feAtencionCorta) {
        this.feAtencionCorta = feAtencionCorta;
    }

    public String getFeArchivamientoCorta() {
        return feArchivamientoCorta;
    }

    public void setFeArchivamientoCorta(String feArchivamientoCorta) {
        this.feArchivamientoCorta = feArchivamientoCorta;
    }
